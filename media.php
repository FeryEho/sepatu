...
<div id="wrapper_sec">
    ...
    <div class="rightnavi"><!-- tombol login & info waktu-->
      
      <!-- tombol login/logout berdasarkan session -->
        <?php if ($_SESSION['leveluser'] == 'user'): ?>
            <p class="bold right"><a id="various1" href="logout.php"><img src="images/logout.png"></a></p>
        <?php else: ?>
            <p class="bold right"><a id="various1" href="#inline1"><input style='width: 150px; height: 30px;' class= tombol2></a></p>
        <?php endif; ?>
        <!-- <p class="bold right"><a id="various1" href="#inline1"><input style='width: 150px; height: 30px;' class= tombol2 ></a></p> -->

      <div class="clear"><!-- skrip DATE and TIME -->
          <ul>
            <SCRIPT language=JavaScript src="almanak.js"></SCRIPT> 
            <span class="style1">I</span>
            <?php //menyapa user. jika belum login, disebut pengunjung.
                $jam = date("H");
              if ($_SESSION['leveluser'] == 'user'):
                $nama = ucfirst($_SESSION['namauser']);
              else:
                $nama = "Pengunjung";
              endif;
    ...
    <div id="content_sec">
      ...
      while($t=mysql_fetch_array($ym)){
        echo "<span class='table2'><b><br /><p>&bull; $t[nama] </b>
              ...
              <img src='http://opi.gmail.com/online?u=$t[username]&amp;m=g&amp;t=1' border='0' height='16' width='64'></a>
              </p><br />";
      }
      ?>
                          </div></td>
...
?>
    ...
    <div id="footer">
        <div class="aboutus">
        	<h5>Tentang Kami</h5>
        	<p>
            	Sepatu Bagus.com  adalah toko fashion sepatu online, yang menyediakan segala kebutuhan fashion anda. Sepatu Bagus.com ingin memberikan kemudahan kepada para calon pembeli, cara santai, mudah dan hemat dalam berbelanja fashion berkualias dengan harga yang terjangkau.            </p>
        ...
        <div class="contactus">
            ...
            <ul>
                ...
                <li class="email"><span class="bold">Email:</span> <a href="mailto:ferycahibbjik@gmail.com">ferycahibbjik@gmail.com</a></li>
                <li class="skype"><span class="bold">Skype:</span> FeryFebrianto</li>
            </ul>
        </div>
        <div class="clear"></div>
        <div class="copyright_network">
        	<p>Copyright ©2011 Develoved by: Kelompok 2 E-commerce: 07 TPLP 015 Universitas Pamulang </p>
            <ul class="network"><li>
            	<script language="javascript">
...
<!-- setelah klik tombol login -->
  <div style="display: none;">
  		<div id="inline1" style="width:400px;">
  			<h2>LOGIN ANGGOTA</h2>
      <div class="clear"></div>
      <p>Anda anggota? bila tidak <a href="daftar_user.php" class="colr2">DAFTAR</a>, di sini.</p>
      <div class="clear"></div>
      <a href="daftar_user.php" class="left"><img src="images/signup.gif" alt="" /></a> &nbsp;<a href="lupa_pass.php" class="left"><img src="images/forgot.gif" alt="" /></a>
  ...
  <!-- END validasi form login -->

  <!-- form login -->
    <form name="login" action="cek_login_user.php" method="POST" onSubmit="return validasi(this)">
      <ul class="forms">
        <li class="txt">User Name</li>
          <li class="inputfield"><input type="text" name="username" class="bar" /></li>
      </ul>
      <ul class="forms">
