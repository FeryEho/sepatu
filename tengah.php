...
elseif ($_GET[module]=='keranjangbelanja'){
  ...
  echo "<tr><td colspan=6 align=right><br>
              <span class='table3'>Total:</td><td colspan=2><br><span class='table3'>Rp. $total_rp,-</b>
            </td>
        </tr>
        <tr>
          <td colspan=2><br /><a href=javascript:history.go(-1)>
            <input style='width: 135px; height: 22px;' type=submit  class= simplebtn value='LANJUTKAN BELANJA'></a><br />
          </td>
          <td colspan=2><br />
            <input style='width: 130px; height: 22px;' type=submit  class= simplebtn value='UPDATE KERANJANG'><br />
          </td>
          <td colspan=4 align=right><br /><a href=selesai-belanja.html>
            <div style='padding: 0px 10px 2px 10px;
                        ...
                        background-repeat:
                        repeat-x;'>
            <p style='color:#FFFFFF; padding-right:10px;'>SELESAI BELANJA</p></div><br />
          </td>
        </tr>
        </tbody>
  </table>";
